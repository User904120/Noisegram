...
import org.telegram.tlrpc.models.SchemeRules
...
abstract class GenerateSchemeTask : DefaultTask() {
    ...
    fun generate() {
        ...
        val tlSchemaFilter = tlSchemaFull.applyRules(SchemeRules.rules)
        ...
        val dep = SchemeRules.rules.databaseTypes
    ...
    private fun generateSchemeClassForType(
        ...
        for (constructor in constructors) {
            ...
            if (!SchemeRules.rules.filterConstructor(constructor.tl.key.name)) continue
